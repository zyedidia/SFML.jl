...
function RenderWindow(mode::VideoMode, title::String, settings::ContextSettings, style::WindowStyle...)
    ...
    window = RenderWindow(ccall((:sfRenderWindow_create, "libcsfml-graphics"), Ptr{Void}, (VideoMode, Ptr{Cchar}, Uint32, Ref{ContextSettings},), mode, title, style_int, settings_ptr))
...
function set_vsync_enabled(window::RenderWindow, enabled::Bool)
    ccall((:sfRenderWindow_setVerticalSyncEnabled, "libcsfml-graphics"), Void, (Ptr{Void}, Int32,), window.ptr, enabled)
end

function isopen(window::RenderWindow)
    return Bool(ccall((:sfRenderWindow_isOpen, "libcsfml-graphics"), Int32, (Ptr{Void},), window.ptr))
end

function pollevent(window::RenderWindow, event::Event)
    return Bool(ccall((:sfRenderWindow_pollEvent, "libcsfml-graphics"), Int32, (Ptr{Void}, Ptr{Void},), window.ptr, event.ptr))
end

function waitevent(window::RenderWindow, event::Event)
    return Bool(ccall((:sfRenderWindow_waitEvent, "libcsfml-graphics"), Int32, (Ptr{Void}, Ptr{Void},), window.ptr, event.ptr))
end

function set_position(window::RenderWindow, pos::Vector2)
    pos = to_vec2i(pos)
    ccall((:sfRenderWindow_setPosition, "libcsfml-graphics"), Void, (Ptr{Void}, Vector2i,), window.ptr, pos)
end
...
function get_size(window::RenderWindow)
    return to_vec2i(ccall((:sfRenderWindow_getSize, "libcsfml-graphics"), Vector2u, (Ptr{Void},), window.ptr))
end

function set_title(window::RenderWindow, title::String)
    ccall((:sfRenderWindow_setTitle, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Cchar},), window.ptr, title)
end

function set_icon(window::RenderWindow, pixels::Array{Uint8}, width=64, height=64)
    ccall((:sfRenderWindow_setIcon, "libcsfml-graphics"), Void, (Ptr{Void}, Uint32, Uint32, Ptr{Uint8},), window.ptr, width, height, pointer(pixels))
end
...
function set_visible(window::RenderWindow, visible::Bool)
    ccall((:sfRenderWindow_setVisible, "libcsfml-graphics"), Void, (Ptr{Void}, Int32,), window.ptr, visible)
end

function set_mousecursor_visible(window::RenderWindow, visible::Bool)
    ccall((:sfRenderWindow_setMouseCursorVisible, "libcsfml-graphics"), Void, (Ptr{Void}, Int32,), window.ptr, visible)
end

function set_keyrepeat_enabled(window::RenderWindow, enabled::Bool)
    ccall((:sfRenderWindow_setKeyRepeatEnabled, "libcsfml-graphics"), Void, (Ptr{Void}, Int32,), window.ptr, enabled)
end

function set_active(window::RenderWindow, active::Bool)
    ccall((:sfRenderWindow_setActive, "libcsfml-graphics"), Void, (Ptr{Void}, Int32,), window.ptr, active)
end

function requestfocus(window::RenderWindow)
    ccall((:sfRenderWindow_requestFocus, "libcsfml-graphics"), Void, (Ptr{Void},), window.ptr)
end

function hasfocus(window::RenderWindow)
    return Bool(ccall((:sfRenderWindow_hasFocus, "libcsfml-graphics"), Int32, (Ptr{Void},), window.ptr))
end

function set_view(window::RenderWindow, view::View)
    ccall((:sfRenderWindow_setView, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void},), window.ptr, view.ptr)
    window._view = view
end

function get_view(window::RenderWindow)
    return View(ccall((:sfRenderWindow_getView, "libcsfml-graphics"), Ptr{Void}, (Ptr{Void},), window.ptr))
end

function get_default_view(window::RenderWindow)
    return View(ccall((:sfRenderWindow_getDefaultView, "libcsfml-graphics"), Ptr{Void}, (Ptr{Void},), window.ptr))
end

function get_viewport(window::RenderWindow)
    return ccall((:sfRenderWindow_getViewport, "libcsfml-graphics"), IntRect, (Ptr{Void},), window.ptr)
end
...
function draw(window::RenderWindow, object::CircleShape, renderStates::Ptr{Void})
    ccall((:sfRenderWindow_drawCircleShape, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void}, Ptr{Void},), window.ptr, object.ptr, renderStates)
end

function draw(window::RenderWindow, object::RectangleShape, renderStates::Ptr{Void})
    ccall((:sfRenderWindow_drawRectangleShape, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void}, Ptr{Void},), window.ptr, object.ptr, renderStates)
end

function draw(window::RenderWindow, object::Sprite, renderStates::Ptr{Void})
    ccall((:sfRenderWindow_drawSprite, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void}, Ptr{Void},), window.ptr, object.ptr, renderStates)
end

function draw(window::RenderWindow, object::RenderText, renderStates::Ptr{Void})
    ccall((:sfRenderWindow_drawText, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void}, Ptr{Void},), window.ptr, object.ptr, renderStates)
end

function draw(window::RenderWindow, object::ConvexShape, renderStates::Ptr{Void})
    ccall((:sfRenderWindow_drawConvexShape, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void}, Ptr{Void},), window.ptr, object.ptr, renderStates)
end

function draw(window::RenderWindow, object::VertexArray, renderStates::Ptr{Void})
    ccall((:sfRenderWindow_drawVertexArray, "libcsfml-graphics"), Void, (Ptr{Void}, Ptr{Void}, Ptr{Void},), window.ptr, object.ptr, renderStates)
end
...
function pixel2coords(window::RenderWindow, point::Vector2, targetview::View=get_view(window))
    ...
    return ccall((:sfRenderWindow_mapPixelToCoords, "libcsfml-graphics"), Vector2f, (Ptr{Void}, Vector2i, Ptr{Void},), window.ptr, point, targetview.ptr)
end
