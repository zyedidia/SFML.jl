...
@windows_only begin
	if isdir(Pkg.dir("WinRPM"))
		...
		run(`gcc -I$mingw_include -I$deps_dir\\CSFML\\include -L$deps_dir\\CSFML\\bin -lcsfml-network-2 -lcsfml-window-2 -lcsfml-graphics-2 -shared -o $(Pkg.dir("SFML"))\\deps\\libjuliasfml.dll event.o shader.o Network.o`)
